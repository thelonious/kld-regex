...
class NFAGraph {
    ...
    toString() {
        ...
        while (queue.length > 0) {
            ...
            result.push(format("{0:s3}", (node.acceptState != -1) ? node.acceptState : " "));
            result.push(" ");
            ...
            result.push(format("{0:s2} ", node.id));

            if (node.input) {
                result.push("(");
                result.push(node.input.toString());
                result.push(")");
            }
            ...
            if (node.epsilon.length > 0) {
                ...
                for (var i = 0; i < node.epsilon.length; i++) {
                    ...
                    result.push(epsilon.id);

                    if (epsilon.id > node.id) queue.push(epsilon);
                }
            ...
            if (node.next) {
                result.push(" => ");
                result.push(node.next.id);

                if (node.next.id > node.id) queue.push(node.next);
            }
