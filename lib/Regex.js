...
class Regex {
    ...
    static compile(source) {
        ...
        let nfa_graph = builder.parse(source);
        var result = null;
        ...
        if (nfa_graph !== null) {
            ...
            result = converter.convert(nfa_graph);
            // builder.dfa_graph = converter.dfa_nodes;
        }
        ...
        if (this.currentCharacter == '(') {
            ...
            switch (this.currentCharacter) {
                case '.':
                    ...
                    cc.caseSensitive = this.caseSensitive;
                    cc.addInput("\r", "\n");
                    cc.complement = true;
                    node.add(cc);
                    break;
	...
	parseCharacterClass() {
        ...
        cci.caseSensitive = this.caseSensitive;
        ...
        while (this.hasText && this.currentCharacter != ']') {
            switch (this.currentCharacter) {
                ...
                case '\\':
                    ...
                    cci.addInput(input.getCharacters());
                    break;
